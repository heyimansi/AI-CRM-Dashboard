...
const SOURCE_COLORS = ["#6366f1", "#818cf8", "#4338ca", "#a5b4fc", "#4f46e5", "#c7d2fe"];
...
function EngagementChart({ trend }) {
  ...
  const renderPeak = (props) => {
    ...
    return (
      <g>
        <circle cx={cx} cy={y} r={5} fill="#4338ca" stroke="#fff" strokeWidth={2} />
        <rect x={cx - 26} y={y - 34} width={52} height={22} rx={11} fill="#4338ca" />
