...
export default function Login() {
  ...
  return (
    <AuthShell>
      ...
      <button
        onClick={useDemo}
        className="mt-3 w-full rounded-lg border border-dashed border-brand-300 py-2.5 text-sm font-medium text-brand-700 transition hover:bg-brand-50 hover:border-brand-400"
      >
